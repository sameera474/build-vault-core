-- Fix allocate_report_number to directly access projects table
-- SECURITY DEFINER allows bypassing RLS when needed
...
DECLARE 
  ...
  v_lab text;
BEGIN
  -- Direct query to projects table (SECURITY DEFINER bypasses RLS)
