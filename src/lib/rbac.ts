 ...
 */
export function canSeeMenuItem(role: string | null | undefined, menuItem: string): boolean {
  if (!role) return false;
 ...
 */
export function isOwn(resourceCreatorId: string | null | undefined, userId: string | null | undefined): boolean {
