...
export default function Team() {
  ...
  const roleFeatures = {
    ...
    project_manager: [
      ...
      "Full access to test reports across all projects",
    ],
    quality_manager: [
        ...
        <CardContent className="space-y-3 text-blue-800">
          <div className="grid md:grid-cols-2 gap-4">
            <div>
              ...
              <p className="text-sm">
                Per project: Admin assigns Project Managers, Quality Manager,
                Material Engineer, Technicians, and Consultant reviewers.
              </p>
            </div>
            <div>
              <h4 className="font-semibold mb-2">Consultant Rules:</h4>
              <p className="text-sm">
                • Consultants are read-only until approval step
              </p>
              <p className="text-sm">
                • Finalization requires consultant approval if flagged
              </p>
            ...
            <div className="space-y-4">
              ...
              <div className="pt-2">
                ...
                <ul className="space-y-1 max-h-32 overflow-y-auto">
                  {roleFeatures[
                    currentUserRole as keyof typeof roleFeatures
                  ]?.map((feature, index) => (
                    <li
                      key={index}
                      className="flex items-center gap-2 text-sm text-muted-foreground"
